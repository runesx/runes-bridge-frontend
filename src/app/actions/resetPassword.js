...
export function resetPassword(props) {
  ...
  return function (dispatch) {
    axios.post(`${process.env.API_URL}/reset-password`, props)
      .then(() => {
...
export function verifyResetPassword(props) {
  return function (dispatch) {
    axios.post(`${process.env.API_URL}/reset-password/verify`, props)
      .then(() => {
...
export function resetPasswordNew(props) {
  return function (dispatch) {
    axios.post(`${process.env.API_URL}/reset-password/new`, props)
      .then((response) => {
