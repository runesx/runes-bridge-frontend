...
export const amountFormatter = (x) => i18n.number(x, {
  style: 'decimal',
  minimumFractionDigits: 2,
  maximumFractionDigits: x < 1 ? 6 : 2,
})

export const percentFormatter = (x, decimals = 2) => i18n.number(x, {
  style: 'percent',
...
export const formatWeiToNumber = (x, locale = 'en') => {
  ...
  const format = strEth < 10000 ? '0.00000000' : '0.00a';
  numeral.locale(locale);
  console.log('formatWeiToNumber');
  console.log(format);
  console.log(strEth);
