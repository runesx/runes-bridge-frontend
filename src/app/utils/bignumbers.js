...
export const hasValue = (x) => !(!x || !parseFloat(x.toString()))

export const convertFromUnits = (value, decimals = 18) => BigNumber(value.toString()).dividedBy(Math.pow(10, decimals))

export const convertToUnits = (value, decimals = 18) => BigNumber(value.toString())
...
export const calcPercent = (a, b) => {
  ...
  return BigNumber(a.toString()).multipliedBy(100).dividedBy(divisor.toString())
}
...
export const amountsToPercentages = (...amounts) => {
  ...
  return amounts.map((x) => new BigNumber(x.toString()).multipliedBy(100).dividedBy(total).toNumber())
}

export const calculateGasMargin = (value) => new BigNumber(value.toString())
  .multipliedBy(1.3)
  .decimalPlaces(0)
  .toString()
...
export const differenceOf = (a, b) => new BigNumber(a.toString()).minus(b.toString())

export const sort = (amounts, selector, reverse = false) => [...amounts].sort((a, b) => {
