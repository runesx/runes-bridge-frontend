...
export default function Otp({ helper, otp, setOtp }) {
  ...
  return (
    <div style={{
      backgroundColor: 'white', display: 'flex', flexDirection: 'row', borderRadius: 5, justifyContent: 'center',
    }}
    >
      <p>{helper}</p>
      <input
        ...
        value={otp.slice(0, 1)}
        style={{
          fontSize: 24, width: 38, height: 40, display: 'flex', alignItems: 'center', justifySelf: 'center', textAlign: 'center', marginRight: 5,
        }}
        onChange={(event) => {
      ...
      <input
        ...
        value={otp.slice(5)}
        style={{
          fontSize: 24, width: 38, height: 40, display: 'flex', alignItems: 'center', justifySelf: 'center', textAlign: 'center',
        }}
        onChange={(event) => {
          if (event.target.value !== '' && event.target.value.length === 1 && isNumeric(event.target.value)) {
            setOtp(otp + event.target.value);
