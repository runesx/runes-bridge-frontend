...
export const useTransactionStorage = () => {
  ...
  const updateToError = (chainId, account, txHash) => updateTx(chainId, account, txHash, 'Error')
  const updateToSuccess = (chainId, account, txHash) => updateTx(chainId, account, txHash, 'Success')
