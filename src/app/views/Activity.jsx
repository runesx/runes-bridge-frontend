...
const MyActivity = (props) => {
  ...
  useEffect(() => {
    const tempUserActivity = recenUserActivity.data.map((userActivity) => {
      ...
      if (userActivity.type === 'depositComplete') {
        return {
          date: userActivity.createdAt,
      ...
      if (userActivity.type === 'withdrawComplete') {
        return {
          date: userActivity.createdAt,
      ...
      if (userActivity.spender) {
        if (user.data.username === userActivity.spender.username) {
          return {
            date: userActivity.createdAt,
            type: userActivity.type === 'depositAccepted' ? `${userActivity.earner.username} started watching your Surf Slot`
              : userActivity.type === 'depositComplete' ? `${userActivity.earner.username} completed watching your Surf Slot`
                : userActivity.type === 'login' ? 'You created a surf order'
                  : userActivity.type === 'logout' ? 'You cacneled a surf order'
